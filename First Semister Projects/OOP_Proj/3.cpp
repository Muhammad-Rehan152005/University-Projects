...
int main(){
    ...
    do {
        ...
        cout << "==> Press (3) : To Append Attribtes (Profession, City) in Your Nodes\n==> Press (4) : To Print Neighbor of Node\n";
        cout << "==> Press (5) : To Print data of AttributedGraph2\n==> Press (0) - To Exit\n";
        cin >> id;
        if (id == 1) {
            int objid;
    ...
    cout<<"\nCheck SimpleGraph.cpp , SimpleNode.cpp , attributedNode2.cpp, attributedGraph2.cpp files for my implementation of Question # 3\n";
